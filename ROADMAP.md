...
| Canal de retours utilisateurs (bugs, idées) : e-mail choisi par FlhFly le 2026-09-14 ; rangée « Signaler un bug ou proposer une idée » prête, masquée tant que l'adresse n'est pas renseignée | 🔄 adresse en attente |
| Vérification du catalogue (C16, plan en 5 étapes du 2026-09-14) : script de contrôle et rapport, puis revue par lots (populaires d'abord), `verifieLe` par service | 🔄 script et rapport livrés ; lot 1 « populaires » (12 services) revu le 2026-09-14, catalogue v4 ; lots suivants par catégorie |
