...
export const en: Dictionnaire = {
  ...
  'toast.paiementConfirme': 'Payment of {date} confirmed',
  ...
  'fiche.rappel': 'Reminder',
  'fiche.rappel.valeur': '{date} — {texte}',
  'fiche.echeance': 'Next renewal',
  'paiement.titre': 'Renewal payment',
  'paiement.echeance': 'Due {date} · {montant}',
  'paiement.aConfirmer': 'Not confirmed yet',
  'paiement.confirme': 'Paid · confirmed on {date}',
  'paiement.marquer': 'Mark as paid',
  'paiement.annuler': 'Undo',
  ...
  'fiche.annuel': 'Switch to yearly',
  'fiche.annuel.texte': '≈ {montant} saved per year with “{formule}” at {prix}.',
  'fiche.direct': 'Cheaper direct',
  'fiche.direct.texte': '{montant} less per period by subscribing on the website: {prix}.',
  'fiche.usage': 'Usage & real cost',
  'fiche.usage.question': 'Uses / week',
  'fiche.usage.jamais': 'Never',
  'fiche.usage.fois': '{n}×',
  'fiche.usage.aide': 'Declare your usage to estimate the cost per use.',
  'fiche.usage.cout': '≈ {montant} per use this month',
  'fiche.usage.zero': 'Not used this month — {montant} spent anyway',
  'fiche.paiements': 'Latest payments',
  'fiche.paiements.cumul': 'Total spent since {date}',
  'fiche.paiements.tout.un': 'See the payment',
  'fiche.paiements.tout.plusieurs': 'See all {n} payments',
  'fiche.paiements.reduire': 'Show less',
  'fiche.notes': 'Notes',
  'fiche.modifier': 'Edit',
  'fiche.pause': 'Pause',
  ...
  'edition.rappel': 'Reminder on a date',
  'edition.rappel.aide':
    'A note for later: “renegotiate the box”, “compare electricity offers”… The app reminds you on the chosen date.',
  'edition.rappel.date': 'Reminder date',
  'edition.rappel.texte': 'Reminder',
  'edition.rappel.texte.ph': 'e.g. renegotiate the box',
  ...
  'toast.importeReleve.un': '{n} subscription added from the statement',
  'toast.importeReleve.plusieurs': '{n} subscriptions added from the statement',
  ...
  'import.csv.colonnes': 'File columns',
  'import.csv.colonnes.aide':
    'Pick the separator, whether the first row is a header, and the column holding each piece of information. The preview updates at once.',
  'import.csv.colonnes.modifier': 'Change columns',
  'import.csv.colonnes.fermer': 'Hide columns',
  'import.csv.separateur': 'Separator',
  'import.csv.enTete': 'First row is a header',
  'import.csv.colonne.numero': 'Column {n}',
  'import.csv.colonne.aucune': 'None',
  'import.releve.badge': 'Bank',
  'import.releve.titre': 'Bank statement',
  'import.releve.sous': 'Automatic detection of recurring payments (CSV from your bank)',
  'import.releve.info': '{o} transactions analysed · {r} recurring payments detected',
  'import.releve.detail': '{n} payments · last on {date}',
  'import.releve.dejaSuivi': 'already tracked',
  'import.releve.nouveau': 'new',
  'import.releve.ajouter.un': 'Add {n} subscription',
  'import.releve.ajouter.plusieurs': 'Add {n} subscriptions',
  'import.releve.aide':
    'Untick anything that is not a subscription. Price, name and due date can be edited afterwards.',
  'import.releve.rien': 'Nothing to add — everything is already tracked',
  'import.releve.aucun':
    'No recurring payment detected. Check the columns, or export a longer period (at least 3 months).',
  'import.releve.colonnes.aide':
    'Set the separator, whether the first line is a header, and where the date, label and amount are.',
  'import.releve.colonne.date': 'Date',
  'import.releve.colonne.libelle': 'Label',
  'import.releve.colonne.montant': 'Amount (debit)',
  'import.releve.note':
    'The statement is analysed on your device, never sent or stored: only the subscriptions you add are saved.',
  ...
  'finances.budget.global': 'Overall',
  'finances.budget.definir': 'Set a budget',
  'finances.budget.aide': 'Set a monthly cap: the app alerts you as soon as it is exceeded.',
  'finances.budget.champ': 'Monthly cap ({devise})',
  'finances.budget.ph': '150',
  'finances.budget.reste': '{montant} left under the cap',
  'finances.budget.depasse': 'Over by {montant}',
  'finances.budget.retirer': 'Remove the budget',
  'finances.objectif': 'Savings goal',
  'finances.objectif.definir': 'Set a goal',
  'finances.objectif.aide':
    'Set a monthly target and a date: the card tracks your progress with every change.',
  'finances.objectif.cible': 'Monthly target ({devise})',
  'finances.objectif.ph': '100',
  'finances.objectif.date': 'By',
  'finances.objectif.sous': 'Get under {montant} / month by {date}',
  'finances.objectif.reste': '{montant} still to cut',
  'finances.objectif.atteint': 'Goal reached — {montant} under the target',
  'finances.objectif.datePassee': 'Date passed — {montant} still to cut',
  'finances.objectif.retirer': 'Remove the goal',
  ...
  'finances.economies': 'Possible savings',
  'finances.economies.annuel': '{nom}: switch to yearly',
  'finances.economies.canal': '{nom}: cheaper direct',
  'finances.economies.gain': '≈ {montant} saved per year',
  'finances.economies.note':
    'Based on the indicative catalog prices as of {d} and the price you pay.',
  'finances.doublons': 'Possible duplicates',
  'finances.doublons.ligne': '{n} services · {categorie}',
  'finances.doublons.moinsUtilise':
    'Cancelling the least used ({nom}) would free ~{montant} / month',
  'finances.doublons.moinsCher':
    'Usage not declared — the cheapest ({nom}) weighs ~{montant} / month',
  'finances.doublons.aucun': 'No duplicates by category.',
  ...
  'alertes.budget.titre': 'Monthly budget exceeded by {montant}',
  'alertes.budget.sous': 'Cap {budget} — cut back or adjust it in Finances',
  'alertes.rappel.pastille': 'Note',
  'alertes.rappel.titre': '{nom}: {texte}',
  'alertes.rappel.aujourdhui': 'Reminder due today',
  'alertes.rappel.depuis.un': 'Reminder of {date}, {n} day ago',
  'alertes.rappel.depuis.plusieurs': 'Reminder of {date}, {n} days ago',
  ...
  'alertes.payer': 'Paid',
  'alertes.payer.aria': 'Mark as paid: {nom}, due {date}',
