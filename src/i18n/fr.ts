...
export const fr = {
  ...
  'toast.paiementConfirme': 'Paiement du {date} confirmé',
  ...
  'paiement.titre': 'Paiement de l’échéance',
  'paiement.echeance': 'Échéance du {date} · {montant}',
  'paiement.aConfirmer': 'Pas encore confirmée',
  'paiement.confirme': 'Payée · confirmé le {date}',
  'paiement.marquer': 'Marquer payé',
  'paiement.annuler': 'Annuler',
  ...
  'fiche.annuel': 'Passer en annuel',
  'fiche.annuel.texte': '≈ {montant} économisés par an avec « {formule} » à {prix}.',
  'fiche.direct': 'Moins cher en direct',
  'fiche.direct.texte': '{montant} de moins par période en s’abonnant sur le site : {prix}.',
  'fiche.usage': 'Usage & coût réel',
  'fiche.usage.question': 'Utilisations / semaine',
  'fiche.usage.jamais': 'Jamais',
  'fiche.usage.fois': '{n}×',
  'fiche.usage.aide': 'Déclarez votre usage pour estimer le coût par utilisation.',
  'fiche.usage.cout': '≈ {montant} par utilisation ce mois-ci',
  'fiche.usage.zero': 'Non utilisé ce mois-ci — {montant} dépensés quand même',
  ...
  'toast.importeReleve.un': '{n} abonnement ajouté depuis le relevé',
  'toast.importeReleve.plusieurs': '{n} abonnements ajoutés depuis le relevé',
  ...
  'import.releve.badge': 'Banque',
  'import.releve.titre': 'Relevé bancaire',
  'import.releve.sous': 'Détection automatique des paiements récurrents (CSV de votre banque)',
  'import.releve.info': '{o} opérations analysées · {r} paiements récurrents détectés',
  'import.releve.detail': '{n} paiements · dernier le {date}',
  'import.releve.dejaSuivi': 'déjà suivi',
  'import.releve.nouveau': 'nouveau',
  'import.releve.ajouter.un': 'Ajouter {n} abonnement',
  'import.releve.ajouter.plusieurs': 'Ajouter {n} abonnements',
  'import.releve.aide':
    'Décochez ce qui n’est pas un abonnement. Prix, nom et échéance restent modifiables ensuite.',
  'import.releve.rien': 'Rien à ajouter — tout est déjà suivi',
  'import.releve.aucun':
    'Aucun paiement récurrent détecté. Vérifiez les colonnes, ou exportez une période plus longue (3 mois au moins).',
  'import.releve.colonnes.aide':
    'Indiquez le séparateur, si la première ligne est un titre, et où se trouvent la date, le libellé et le montant.',
  'import.releve.colonne.date': 'Date',
  'import.releve.colonne.libelle': 'Libellé',
  'import.releve.colonne.montant': 'Montant (débit)',
  'import.releve.note':
    'Le relevé est analysé sur votre appareil, n’est jamais envoyé ni conservé : seuls les abonnements ajoutés sont enregistrés.',
  ...
  'finances.economies': 'Économies possibles',
  'finances.economies.annuel': '{nom} : passer en annuel',
  'finances.economies.canal': '{nom} : moins cher en direct',
  'finances.economies.gain': '≈ {montant} économisés par an',
  'finances.economies.note':
    'D’après les tarifs indicatifs du catalogue au {d} et le prix que vous payez.',
  'finances.doublons': 'Doublons potentiels',
  'finances.doublons.ligne': '{n} services · {categorie}',
  'finances.doublons.moinsUtilise':
    'Résilier le moins utilisé ({nom}) libérerait ~{montant} / mois',
  'finances.doublons.moinsCher': 'Usage non déclaré — le moins cher ({nom}) pèse ~{montant} / mois',
  'finances.doublons.aucun': 'Aucun doublon par catégorie.',
  ...
  'alertes.payer': 'Payé',
  'alertes.payer.aria': 'Marquer payé : {nom}, échéance du {date}',
